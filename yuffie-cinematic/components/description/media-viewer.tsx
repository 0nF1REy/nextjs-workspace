...
export default function MediaViewer({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/95 flex flex-col">
      {/* Top Bar */}
      <div className="flex justify-between items-center p-4 text-white text-lg">
        <button
          onClick={onClose}
          aria-label="Fechar"
      ...
      {/* Info Section */}
      <div className="bg-black/70 text-gray-200 p-4 text-sm flex justify-between items-start">
        <div>
          <p className="text-yellow-400">{currentImage.title}</p>
          ...
          <p className="mt-1">
            <span className="font-semibold">Títulos:</span> Arquivo X
          </p>
