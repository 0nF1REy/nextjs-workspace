...
export default function AddMoviePage() {
      ...
      <div className="min-h-screen w-full bg-[#131b22] text-gray-100 flex items-center justify-center">
        <Card className="w-full max-w-md bg-[#0d1118] border border-green-900/40">
          <CardContent className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-green-500 mb-4">Filme Cadastrado!</h2>
            <p className="text-gray-300">O filme foi adicionado com sucesso ao catálogo.</p>
          </CardContent>
        </Card>
      </div>
    );
  ...
  return (
    <div className="min-h-screen w-full bg-[#131b22] text-gray-100">
      ...
      <div className="w-full max-w-screen-lg mx-auto px-4 sm:px-6 lg:px-8 py-16">
        {/* Header */}
        ...
        <Card className="bg-[#0d1118] border border-red-900/40">
          <CardHeader>
            <CardTitle className="text-xl text-red-400">Informações do Filme</CardTitle>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <Label htmlFor="title" className="text-gray-300 font-medium">Título *</Label>
                  <Input
                    id="title"
                    {...register("title")}
                ...
                <div>
                  <Label htmlFor="director" className="text-gray-300 font-medium">Diretor *</Label>
                  <Input
                    id="director"
                    {...register("director")}
                  ...
                  />
                  {errors.director && (
                    <p className="text-red-400 text-sm mt-1">{errors.director.message}</p>
                  )}
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="year" className="text-gray-300 font-medium">Ano *</Label>
                  <Input
                    id="year"
                    type="number"
                ...
                <div>
                  <Label htmlFor="duration" className="text-gray-300 font-medium">Duração (min) *</Label>
                  <Input
                    id="duration"
                    type="number"
                ...
                <div>
                  <Label htmlFor="rating" className="text-gray-300 font-medium">Avaliação (0-5) *</Label>
                  <Input
                    id="rating"
                    type="number"
                    step="0.1"
              ...
              {/* Sinopse */}
              <div>
                <Label htmlFor="synopsis" className="text-gray-300 font-medium">Sinopse *</Label>
                <textarea
                  id="synopsis"
                  {...register("synopsis")}
                ...
                />
                {errors.synopsis && (
                  <p className="text-red-400 text-sm mt-1">{errors.synopsis.message}</p>
                )}
              </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-3">
                  <Label className="text-gray-300 font-medium">Elenco Principal *</Label>
                  <Button
                    type="button"
                    size="sm"
                ...
                {errors.cast && (
                  <p className="text-red-400 text-sm mt-1">{errors.cast.message}</p>
                )}
              </div>
